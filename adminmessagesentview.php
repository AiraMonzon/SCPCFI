         ...
         if(isset($_POST['send_message']))
            {
                ...
                if(empty($replymessage)){
                        header("Location: adminmessagesentview.php?error=Message is required&id=$id&$user_data");
                        exit();
                }
                else
                {
                    ...
                    $replyfrom_username = $_SESSION['username'];
                        ...
                        if($result2)
                        {
                                ...
                                header("Location: adminmessagesentview.php?id=$id&addsuccess=Message has been sent successfully");
                        exit();
                        }
                        else
                        {
                                header("Location: adminmessagesentview.php?id=$id&adderror=Unknown error occurred&$user_data");
                        exit();
                        }
                ...
                $sql= "SELECT * FROM messages WHERE id= '$id'";
                             ...
                             if (mysqli_num_rows($result) > 0) 
                             {
                                        ...
                                        exit();
                                              ...
                                              {
                                              header("Location: adminmessagesentview.php?error=Unknown error occurred&$user_data");
                                        exit();
                                              } 
                                }     
                                else
                              ...
                              header("Location: adminmessagesentview.php?error=The ID is not existing&$user_data");
                              exit();
                                      }
            }
?>
