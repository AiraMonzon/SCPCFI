...
$mail->Body="<h1>$message </h1><a href=http://localhost/scpcfi/userpasswordforgot.php>VERIFY NOW</a>";
...
if (!$mail->send()) {
    header("Location: userpasswordforgot.php?error=Please enter valid email address");
                        exit();
} else {
    header("Location: userpasswordforgot.php?successsend=Verification code was sent to your email successfully!");
                        exit();
}
}
...
$result= mysqli_query($database_connection, $sql);
                ...
                header("Location: userpasswordforgot.php?error=Please enter valid verification code!");
                        exit();
        }
}
?>
