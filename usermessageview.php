         ...
         if(isset($_POST['send_message']))
            {
                ...
                if(empty($replymessage)){
                        header("Location: usermessageview.php?error=Message is required&id=$id&$user_data");
                        exit();
                }
                else
                {
                    ...
                    $replyfrom_username = $_SESSION['username'];
                        ...
                        if($result2)
                        {
                                ...
                                header("Location: usermessageview.php?id=$id&addsuccess=Message has been sent successfully");
                        exit();
                        }
                        else
                        {
                                header("Location: usermessageview.php?id=$id&adderror=Unknown error occurred&$user_data");
                        exit();
                        }
                ...
                $sql= "SELECT * FROM messages WHERE id= '$id'";
                             ...
                             if (mysqli_num_rows($result) > 0) 
                             {
                                        ...
                                        exit();
                                              ...
                                              {
                                              header("Location: usermessageview.php?error=Unknown error occurred&$user_data");
                                        exit();
                                              } 
                                }     
                                else
                              ...
                              header("Location: usermessageview.php?error=The ID is not existing&$user_data");
                              exit();
                                      }
            }
?>
