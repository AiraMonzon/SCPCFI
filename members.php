...
{         
        ...
        if(!empty($searchinput))
        {
            ...
            {
                header("Location: members.php?searcherror=The data is not existing&#listaccount");
                exit();
            }
        } 
        else
        {
            header("Location: members.php?searcherror=Search bar is empty&#listaccount");
            exit();
        }
} 
      ...
      //TO ADD
            if(isset($_POST['add']))
            {
                ...
                if(empty($addfirst_name)){
                        header("Location: members.php?adderror=First Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addfirst_name)){
                        header("Location: members.php?adderror=First Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addfirst_name) <2){
                        header("Location: members.php?adderror=First Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addfirst_name) >35){
                        header("Location: members.php?error=First Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addmiddle_name)){
                        header("Location: members.php?adderror=Middle Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addmiddle_name)){
                        header("Location: members.php?adderror=Middle Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addmiddle_name) <2){
                        header("Location: members.php?adderror=Middle Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addmiddle_name) >35){
                        header("Location: members.php?adderror=Middle Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addlast_name)){
                        header("Location: members.php?adderror=Last Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addlast_name)){
                        header("Location: members.php?adderror=Last Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addlast_name) <2){
                        header("Location: members.php?adderror=Last Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addlast_name) >35){
                        header("Location: members.php?adderror=Last Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addfirst_name) + strlen($addmiddle_name) + strlen($addlast_name)>70){
                        header("Location: members.php?adderror=Full Name is too long must be 70 characters length&$user_data");
                        exit();
                }
                else if(empty($addemail)){
                        header("Location: members.php?adderror=Email is required&$user_data");
                        exit();
                }
                else if(!filter_var($addemail, FILTER_VALIDATE_EMAIL)){
                        header("Location: members.php?adderror=Email is incorrect&$user_data");
                        exit();
                }              
                else if(empty($addphone)){
                        header("Location: members.php?adderror=Phone Number is required&$user_data");
                        exit();
                }


                else if(!preg_match("/^[0-9]+$/", $addphone)){
                        header("Location: members.php?adderror=Phone Number must contain numbers&$user_data");
                        exit();
                }

                else if(strlen($addphone) <11){
                        header("Location: members.php?adderror=Phone Number is too short must be 11 characters length&$user_data");
                        exit();
                }
                else if(strlen($addphone) >11){
                        header("Location: members.php?adderror=Phone Number is too long must be 11 characters length&$user_data");
                        exit();
                }                                

                else if(empty($addhousestreet)){
                        header("Location: members.php?adderror=House No. or Street Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z0-9\s]+$/", $addhousestreet)){
                        header("Location: members.php?adderror=House No. and Street Name must contain letters or numbers&$user_data");
                        exit();
                }
                else if(strlen($addhousestreet) <2){
                        header("Location: members.php?adderror=House No. and Street Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addhousestreet) >35){
                        header("Location: members.php?adderror=House No. and Street Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addbaranggay)){
                        header("Location: members.php?adderror=Baranggay is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addbaranggay)){
                        header("Location: members.php?adderror=Baranggay must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addbaranggay) <2){
                        header("Location: members.php?adderror=Baranggay is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addbaranggay) >35){
                        header("Location: members.php?adderror=Baranggay is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addcity)){
                        header("Location: members.php?adderror=City is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addcity)){
                        header("Location: members.php?adderror=City must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addcity) <2){
                        header("Location: members.php?adderror=City is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addcity) >35){
                        header("Location: members.php?adderror=City is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addprovince)){
                        header("Location: members.php?adderror=Province is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $addprovince)){
                        header("Location: members.php?adderror=Province must contain letters&$user_data");
                        exit();
                }
                else if(strlen($addprovince) <2){
                        header("Location: members.php?adderror=Province is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($addprovince) >35){
                        header("Location: members.php?adderror=Province is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($addzp)){
                        header("Location: members.php?adderror=ZIP or Postal Code is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[0-9]+$/", $addzp)){
                        header("Location: members.php?adderror=ZIP or Postal Code must contain numbers&$user_data");
                        exit();
                }
                else if(strlen($addzp) <4){
                        header("Location: members.php?adderror=ZIP or Postal Code is too short must be 4 characters length&$user_data");
                        exit();
                }
                else if(strlen($addzp) >4){
                        header("Location: members.php?adderror=ZIP or Postal Code is too long must be 4 characters length&$user_data");
                        exit();
                }
                else if(empty($addbirthdate)){
                        header("Location: members.php?adderror=Birthday is required&$user_data");
                        exit();
                }
                else if(empty($addgender)){
                        header("Location: members.php?adderror=Gender is required&$user_data");
                        exit();
                }
                else if(empty($addusername)){
                        header("Location: members.php?adderror=Username is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z0-9\s\_\-]+$/", $addusername)){
                        header("Location: members.php?adderror=Username must contain letters, numbers or symbols only&$user_data");
                        exit();
                }
                else if(strlen($addusername) <6){
                        header("Location: members.php?adderror=Username is too short must be 6-30 characters length&$user_data");
                        exit();
                }
                else if(strlen($addusername) >30){
                        header("Location: members.php?adderror=Username is too long must be 6-30 characters length&$user_data");
                        exit();
                }
                else if(empty($addpassword)){
                        header("Location: members.php?adderror=Password is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z0-9\w\S]+$/", $addpassword)){
                        header("Location: members.php?adderror=Password must contain letters, numbers or symbols only&$user_data");
                        exit();
                }
                else if(strlen($addpassword) <8){
                        header("Location: members.php?adderror=Password is too short must be 8-32 characters length&$user_data");
                        exit();
                }
                else if(strlen($addpassword) >32){
                        header("Location: members.php?adderror=Password is too long must be 8-32 characters length&$user_data");
                        exit();
                }
                else if(empty($addrepassword)){
                        header("Location: members.php?adderror=Confirm Password is required&$user_data");
                        exit();
                }
                        ...
                        header("Location: members.php?adderror=The confirmation password does not match&$user_data");
                        exit();
                }
                ...
                else
                {
                        ...
                        $sql= "SELECT * FROM users WHERE username= '$addusername'";
                        $result= mysqli_query($database_connection, $sql);
                        $sql2= "SELECT * FROM users WHERE email= '$addemail'";
                        ...
                        if (isset($_POST['addusername']))
                        {
                               ...
                               {
                                header("Location: members.php?adderror=The username/email is already taken&$user_data");
                                exit();
                               } else{
                                ...
                                if($result2)
                                {
                                                ...
                                                $result3= mysqli_query($database_connection, $sql3);
                                        header("Location: members.php?addsuccess=Account has been created successfully");
                                exit();
                                }
                                else
                                {
                                        header("Location: members.php?adderror=Unknown error occurred&$user_data");
                                exit();
                                }
                               }
                        }
      ...
      if(isset($_POST['searchtoupdate']))
            {
                 ...
                 $updateinput = $_POST['updateinput']; 
                        ...
                        $search_query13= "SELECT * FROM users WHERE username= '$updateinput'";
                        ...
                        if($search_result13)
                        {
                              ...
                              {
                                    header("Location: members.php?error=The username is not existing&#updateaccount");
                                    exit();
                              }
                  ...
                  {
                        header("Location: members.php?error=Enter member username&$user_data");
                        exit();
                  }
...
//TO UPDATE
            if(isset($_POST['update']))
            {
                ...
                if(empty($first_name)){
                        header("Location: members.php?error=First Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $first_name)){
                        header("Location: members.php?error=First Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($first_name) <2){
                        header("Location: members.php?error=First Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                        ...
                        header("Location: members.php?error=Middle Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $middle_name)){
                        header("Location: members.php?error=Middle Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($middle_name) <2){
                        header("Location: members.php?error=Middle Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($middle_name) >35){
                        header("Location: members.php?error=Middle Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($last_name)){
                        header("Location: members.php?error=Last Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $last_name)){
                        header("Location: members.php?error=Last Name must contain letters&$user_data");
                        exit();
                }
                else if(strlen($last_name) <2){
                        header("Location: members.php?error=Last Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($last_name) >35){
                        header("Location: members.php?error=Last Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($first_name) + strlen($middle_name) + strlen($last_name)>70){
                        header("Location: members.php?error=Full Name is too long must be 70 characters length&$user_data");
                        exit();
                }
                else if(empty($email)){
                        header("Location: members.php?error=Email is required&$user_data");
                        exit();
                }
                else if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
                        header("Location: members.php?error=Email is incorrect&$user_data");
                        exit();
                }              
                else if(empty($phone)){
                        header("Location: members.php?error=Phone Number is required&$user_data");
                        exit();
                }


                else if(!preg_match("/^[0-9]+$/", $phone)){
                        header("Location: members.php?error=Phone Number must contain numbers&$user_data");
                        exit();
                }

                else if(strlen($phone) <11){
                        header("Location: members.php?error=Phone Number is too short must be 11 characters length&$user_data");
                        exit();
                }
                else if(strlen($phone) >11){
                        header("Location: members.php?error=Phone Number is too long must be 11 characters length&$user_data");
                        exit();
                }                                

                else if(empty($housestreet)){
                        header("Location: members.php?error=House No. or Street Name is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z0-9\s]+$/", $housestreet)){
                        header("Location: members.php?error=House No. and Street Name must contain letters or numbers&$user_data");
                        exit();
                }
                else if(strlen($housestreet) <2){
                        header("Location: members.php?error=House No. and Street Name is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($housestreet) >35){
                        header("Location: members.php?error=House No. and Street Name is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($baranggay)){
                        header("Location: members.php?error=Baranggay is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $baranggay)){
                        header("Location: members.php?error=Baranggay must contain letters&$user_data");
                        exit();
                }
                else if(strlen($baranggay) <2){
                        header("Location: members.php?error=Baranggay is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($baranggay) >35){
                        header("Location: members.php?error=Baranggay is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($city)){
                        header("Location: members.php?error=City is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $city)){
                        header("Location: members.php?error=City must contain letters&$user_data");
                        exit();
                }
                else if(strlen($city) <2){
                        header("Location: members.php?error=City is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($city) >35){
                        header("Location: members.php?error=City is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($province)){
                        header("Location: members.php?error=Province is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z\s]+$/", $province)){
                        header("Location: members.php?error=Province must contain letters&$user_data");
                        exit();
                }
                else if(strlen($province) <2){
                        header("Location: members.php?error=Province is too short must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(strlen($province) >35){
                        header("Location: members.php?error=Province is too long must be 2-35 characters length&$user_data");
                        exit();
                }
                else if(empty($zp)){
                        header("Location: members.php?error=ZIP or Postal Code is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[0-9]+$/", $zp)){
                        header("Location: members.php?error=ZIP or Postal Code must contain numbers&$user_data");
                        exit();
                }
                else if(strlen($zp) <4){
                        header("Location: members.php?error=ZIP or Postal Code is too short must be 4 characters length&$user_data");
                        exit();
                }
                else if(strlen($zp) >4){
                        header("Location: members.php?error=ZIP or Postal Code is too long must be 4 characters length&$user_data");
                        exit();
                }
                else if(empty($gender)){
                        header("Location: members.php?error=Gender is required&$user_data");
                        exit();
                }

                else if(empty($birthdate)){
                        header("Location: members.php?error=Birthday is required&$user_data");
                        exit();
                }
                  
                else if(empty($username)){
                        header("Location: members.php?error=Username is required&$user_data");
                        exit();
                }
                else if(!preg_match("/^[a-zA-Z0-9\s\_\-]+$/", $username)){
                        header("Location: members.php?error=Username must contain letters, numbers or symbols only&$user_data");
                        exit();
                }
                else if(strlen($username) <6){
                        header("Location: members.php?error=Username is too short must be 6-30 characters length&$user_data");
                        exit();
                }
                else if(strlen($username) >30){
                        header("Location: members.php?error=Username is too long must be 6-30 characters length&$user_data");
                        exit();
                }
                ...
                else
                {
                        ...
                        $result= mysqli_query($database_connection, $sql);
                        $sql3= "SELECT * FROM users WHERE username= '$updateinput'";
                        $result3= mysqli_query($database_connection, $sql3);
                        ...
                        if (isset($_POST['username']))
                        {
                                ...
                                if (mysqli_num_rows($result) > 0) 
                               {
                                ...
                                {
                                                $log_username = $_SESSION['username'];
                                                $log_activity = "Update Member"; 
                                                $sql3= "INSERT INTO log_record (log_username,log_activity,log_details)VALUES('$log_username','$log_activity','$username')";
                                                $result3= mysqli_query($database_connection, $sql3);
                                        header("Location: members.php?success=Account has been updated successfully");
                                exit();
                                }
                                else
                                {
                                        header("Location: members.php?error=Unknown error occurred&$user_data");
                                exit();
                                }
                               }else{
                                    $updateinput= $_POST['updateinput'];        
...
{
      header("Location: members.php?#addaccount");
      exit();
}            
if(isset($_POST['updaterefresh']))
{
      header("Location: members.php?#updateaccount");
      exit();
}      
?>
...
<head>
        ...
        <link rel="stylesheet" href="css/adminaccountsD.css"/>
        <title>Member Accounts | SCPCFI</title>
</head> 
<body>
<!-- HEADER NAVIGATION ------------------------------------------------------------------------------------------------------------------------->
      <header>
...
<div class="main">
      ...
      <div class="container-fluid <?php if (isset($_GET['adderror'])){ ?> collapse.show<?php }else{ ?>collapse<?php } ?>" id="addform">
            ...
            <div class="row">
                  ...
                  <div class="col-6">
                        <input class="btn btn-primary btninput" type="submit" name="addrefresh" action="members.php" value="REFRESH">
                  </div>
            </div>
      </div>
 <section class="page-section" id="updateaccount">
      ...
      <div class='col-5'>
            <div class="input-group">
                  <?php if (isset($_GET['updateinput'])) { ?>
                  <input class="form-control" type="text" 
                  name="updateinput" 
                  placeholder="Enter member username . . .";
                  value="<?php echo $_GET['updateinput']; ?>">
                  <?php }else{ ?>
                  <input class="form-control" type="text" 
                  name="updateinput" 
                  placeholder="Enter member username . . ."
                  value="<?php echo $updateinput; ?>">
                  <?php }?>
      ...
      <div class="container-fluid">
            ...
            <div class="row">
                  ...
                  <div class="col-6">
                        <input class="btn btn-primary btninput" type="submit" name="updaterefresh" action="members.php" value="REFRESH">
                  </div>
            </div>
      </div>
            ...
            <div class='row'>
                  ...
                  <div class='col-5'>
                        <div class="input-group">
                              ...
                              <input class="form-control" type="text" 
                              name="searchinput" 
                              placeholder="Enter member data . . .<?php echo $updateinput; ?>";
                  ...
                  <div class='col-3'>
                              ...
                              <a class="dropdown-item" href="members.php?#listaccount">Refresh</a>
                              </div>
                  </div>      
            </div>
      </div> </section>
...
if (isset($_POST['search'])) 
{
        $sql= "SELECT * FROM users WHERE id= '$searchinput' OR first_name LIKE '%$searchinput%' OR middle_name LIKE '%$searchinput%' OR last_name LIKE '%$searchinput%' OR email LIKE '%$searchinput%' OR phone LIKE '%$searchinput%' OR housestreet LIKE '%$searchinput%' OR baranggay LIKE '%$searchinput%' OR city LIKE '%$searchinput%' OR province LIKE '%$searchinput%' OR zp LIKE '%$searchinput%' OR birthdate LIKE '%$searchinput%' OR gender= '$searchinput' OR username LIKE '%$searchinput%'";
        $result= mysqli_query($database_connection, $sql);

        if (mysqli_num_rows($result) > 0) 
        {
                echo "<div class='container-fluid table'><table>";
                echo "<thead><tr><th>Id</th><th>Name</th><th>Gender</th><th>Birthdate</th><th>Address</th><th>Phone No.</th><th>E-mail</th><th>Username</th><th></th></tr></thead>";

                while ($row = mysqli_fetch_assoc($result)) 
                {
                    echo "<tr class='infos'><td>{$row['id']}</td><td><a   href='members.php?viewid={$row['id']}'>{$row['first_name']} {$row['middle_name']} {$row['last_name']}</a></td><td>{$row['gender']}</td><td>{$row['birthdate']}</td><td>{$row['housestreet']} {$row['baranggay']} {$row['city']} {$row['province']} {$row['zp']}</td><td>{$row['phone']}</td><td>{$row['email']}</td><td>{$row['username']}</td><td><a   href='members.php?id={$row['id']}'><button type='button' class='btn btn-primary actions' value='DELETE'>DELETE</button></a></td></tr>";
                }
                echo "</table></div>";
        }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class='btn btn-primary' type='submit' name='delete' value='DELETE' href='deleteuseraccount.php?id=<?php echo $idb; ?>&username=<?php echo $usernameb; ?>'>Yes</a>
      </div>
    </div>
  </div>
</div>  
...
<?php if(isset($_GET['viewid'])){  
    $sql = "SELECT * FROM users WHERE id='$_GET[viewid]'";
    $result = mysqli_query($database_connection, $sql) or die("Bad Query: $sql");    
    if(mysqli_num_rows($result) > 0){
    while ($row = mysqli_fetch_assoc($result)) 
    { 
...
<div class="modal fade" id="exampleModalb" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Member Account</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
